...
Finalment, el resum i el gràfic es poden publicar en forma de tweet amb la funció `post_tweet`. Per a que això funcioni correctament, s'han d'emmagatzemar les claus de l'API de Twitter en un fitxer JSON de la següent manera:
...
Una vegada s'ha cerat aquest fitxer ja es pot utilitzar la funció `post_tweet`. 
